...
public class EducationalProgramService : IEducationalProgramService
{
    ...
    public async Task<(IReadOnlyList<EducationalProgramDto> items,
        int totalCount,
        int totalPages)> GetEducationalProgramsAsync(
        int page,
        int pageSize,
        string? search,
        string? degreeLevelIds,
        int sortOrder)
    {
        var query = _context.EducationalPrograms
            .Include(ep => ep.Degree)
        ...
        {
            var source = programs.First(p => p.IdEducationalProgram == program.IdEducationalProgram);
            program.StudentsCount = source.Students.Count;
            program.DisciplinesCount = source.BindMainDisciplines.Count;
        }
    ...
    public async Task<EducationalProgramDto?> GetEducationalProgramAsync(int id)
    {
        ...
        result.DisciplinesCount = program.BindMainDisciplines.Count;
        return result;
    }
        ...
        UpdateEducationalProgramDto dto)
    {
        ...
        {
            return (false, StatusCodes.Status400BadRequest, "Mismatched educational program id.");
        }
